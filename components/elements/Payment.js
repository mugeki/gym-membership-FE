...
export default function Payment({ id, entries, type }) {
	...
	const renderer = ({ hours, minutes, seconds, completed }) => {
		if (completed) {
			...
			return (
				<div
					className={`align-self-center mt-3 ${styles.countdown} rounded-3 `}
				>
					<p className="fs-6 fw-bold m-0 p-1 rounded-3 bg-danger">
