...
export default function PaymentAccepted({
	...
	return (
		<div className="d-flex position-absolute top-50 start-50 translate-middle shadow-lg bg-body rounded justify-content-center">
			<div
				className={`${styles.modalAccepted}  p-3 rounded-3 d-flex flex-column  align-items-center`}
			>
				...
				<a className={`${styles.linkTo}`} href={hrefTo}>
					{messageHref}
				</a>
				<a className={`${styles.linkTo} m-1`} href={hrefTo_2}>
					{messageHref_2}
				</a>
			</div>
		</div>
