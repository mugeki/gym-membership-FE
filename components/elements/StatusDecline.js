...
export default function StatusDecline({entries, type}) {
	...
	return (
        ...
        <div className="d-flex flex-column bg-body rounded align-items-center mb-4">
            <div className={`p-3 shadow-lg rounded-3 d-flex flex-column col-10  align-items-start mt-6 mb-3`}>
                <p className="text-primary fw-bold fs-4 m-0">Hi!</p>
                <p className="m-0 text-primary fw-bold mb-3">Sorry, your payment was declined.</p>
                ...
                <div>
                    <p>
                        If you think you sure there is nothing wrong with your receipt, please 
                        <a className="text-link" href="mailto:alta2@gymmembership.com?subject=I Have Problen with my Receipt"> contact us at email </a>
                ...
                <Button className={`col-12 btn mt-3 mb-3`} onClick={handleSubmit}>submit reupload</Button>
                <CustomModal 
