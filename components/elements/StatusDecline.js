	...
	return (
        ...
        <div className="d-flex bg-body rounded justify-content-center">
            <div className={`p-3 shadow-lg rounded-3 d-flex flex-column col-10  align-items-start mt-6`}>
                ...
                <div>
                    <p className="p-0 m-0">if you think you sure there is nothing wrong with your receipt, please contact us at :</p>
                    <a className="link-primary p-0 m-0" href="mailto:alta2@gymmembership.com?subject=I Have Problen with my Receipt">alta2@gymmembership.com</a>
                </div>
