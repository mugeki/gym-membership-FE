...
export default function PaymentItem({ entries,idActive, setIdActive}) {
    ...
    const active=`${styles.paymentItem} ${styles.bgGrey}  btn  border shadow p-2 mb-5 bg-body rounded`
    const nonActive=`${styles.paymentItem} btn  border shadow p-2 mb-5 bg-body rounded`
	return (
